            ...
            if !messageType!.isEmpty {
                switch messageType! {
                    ...
                    case "getQuestion":
                        ...
                        if questions[0].lastanswered != nil {
                            reply["lastanswered"] = questions[0].lastanswered!.formatted
                        } else {
                            reply["lastanswered"] = "No last answered date"
                        }
                        if questions[0].nextdue != nil {
                            reply["nextdue"] = questions[0].nextdue!.formatted
                        } else {
